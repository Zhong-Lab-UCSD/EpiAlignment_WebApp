...
EpiAligment_URL = "https://beta.epialign.ucsd.edu/backend"
...
class RequestsEpiAlign:
  ...
  def Get_sample(self, runid, gap = 20, total_wait = 172800):
    '''
...
def Main():
  ...
  # Note: the following codes are examples of getting available
  # ENCODE/public peak files and gene clusters using python.
  # These codes will not run when you execute this program.
  #
  # You may implement these codes into your own python code to
  # select desired data.
  #
